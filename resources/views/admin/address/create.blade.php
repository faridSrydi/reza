...
@section('content')
    <main class="flex-1 max-w-[1280px] mx-auto w-full px-6 py-8">
        <div class="flex items-center gap-2 mb-6">
            ...
            <span class="material-symbols-outlined crumb-heart text-[12px] text-primary">favorite</span>
            <span class="text-primary text-sm font-bold">Tambah</span>
        </div>

        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
            <div class="flex flex-col gap-2">
                <h1 class="text-3xl md:text-4xl font-extrabold text-primary tracking-tight">Tambah Alamat</h1>
                <p class="text-primary/60 font-semibold">Isi data alamat untuk pengiriman.</p>
            </div>
            ...
            <div class="relative bg-white dark:bg-background-dark/40 border-4 border-primary/10 rounded-xl p-8 shadow-xl shadow-primary/5 overflow-hidden">
                    ...
                    <div class="flex items-center gap-4 mb-8">
                        <div class="flex flex-col items-center gap-1 shrink-0">
                            <div class="relative flex size-14 items-center justify-center rounded-full lollipop-gradient text-white shadow-lg shadow-primary/30 overflow-hidden">
                                ...
                                <span class="material-symbols-outlined text-3xl font-bold fill-1 relative">add_location</span>
                            </div>
                            <div class="w-2 h-6 bg-orange-200 dark:bg-orange-900 rounded-b-full shadow-sm -mt-1"></div>
                        </div>

                        <div class="min-w-0">
                            <p class="text-xs font-bold uppercase tracking-widest text-primary/60">New Snack-Spot</p>
                            <h2 class="text-2xl font-extrabold text-[#181113] dark:text-white tracking-tight">Alamat Baru</h2>
                            <p class="text-primary/60 font-semibold text-sm mt-1">Biar pengiriman makin sat-set.</p>
                        </div>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="address" rows="4" required
                        ...
                        class="w-full bg-white dark:bg-background-dark border-2 border-primary/20 rounded-xl px-4 py-3 text-sm font-semibold text-primary focus:border-primary focus:ring-0 outline-none placeholder:text-primary/40">{{ old('address') }}</textarea>
                </div>
