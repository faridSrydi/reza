        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 w-full overflow-hidden rounded-3xl border border-[#f3e7ed] dark:border-[#3d2030] bg-white dark:bg-background-dark">
            <div class="hidden lg:block relative overflow-hidden">
                ...
                <div class="absolute bottom-20 left-20 right-20 text-white">
                    <h2 class="text-5xl font-bold serif-text mb-4 leading-tight">Join Our<br />Beauty Ritual</h2>
                    <p class="text-lg font-light max-w-md opacity-90">Create an account to unlock wishlists, faster
                        checkout, and exclusive offers.</p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-center p-8 lg:p-24">
                <div class="w-full max-w-md flex flex-col gap-8">
                    <div class="flex flex-col gap-2">
                        <h1 class="text-4xl font-bold serif-text">Create Account</h1>
                        <p class="text-gray-500 dark:text-gray-400">Please enter your details to sign up.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm font-semibold uppercase tracking-wider text-gray-400" for="name">Full
                                Name</label>
                            <input
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm font-semibold uppercase tracking-wider text-gray-400" for="password">Password</label>
                            <input
                                class="form-input w-full h-14 px-4 rounded-lg bg-[#f8f6f7] dark:bg-[#2d1622] border-[#f3e7ed] dark:border-[#3d2030] text-sm focus:ring-primary"
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm font-semibold uppercase tracking-wider text-gray-400" for="password_confirmation">Confirm Password</label>
                            <input
                                class="form-input w-full h-14 px-4 rounded-lg bg-[#f8f6f7] dark:bg-[#2d1622] border-[#f3e7ed] dark:border-[#3d2030] text-sm focus:ring-primary"
                        ...
                        <div class="relative flex items-center py-4">
                            ...
                            <span class="flex-shrink mx-4 text-xs font-bold text-gray-400 uppercase tracking-widest">Or</span>
                            <div class="flex-grow border-t border-[#f3e7ed] dark:border-[#3d2030]"></div>
                        </div>
