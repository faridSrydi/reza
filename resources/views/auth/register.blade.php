            ...
            <div
                ...
                <div class="flex flex-col items-center text-center mb-8">
                    <div
                        ...
                        <span class="material-symbols-outlined text-6xl text-primary relative z-10">person_add</span>
                    </div>
                    <h1 class="text-[#181113] dark:text-white text-3xl font-black mb-2">Create Your Account</h1>
                    <p class="text-gray-500 dark:text-gray-400 font-medium">Join to save your favorite snacks</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="flex flex-col gap-2">
                        <label class="text-[#181113] dark:text-gray-200 text-sm font-bold px-4">Name</label>
                        <div class="relative">
                            <span
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                ...
                                placeholder="Your sweet name" required autofocus />
                        </div>
                    </div>

                    <div class="flex flex-col gap-2">
                        <label class="text-[#181113] dark:text-gray-200 text-sm font-bold px-4">Email</label>
                        <div class="relative">
                            <span
                                class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-primary/60">alternate_email</span>
                            <input type="email" name="email" value="{{ old('email') }}"
                                class="w-full h-14 pl-12 pr-6 rounded-full border-2 border-primary/10 focus:border-primary focus:ring-0 bg-primary/5 dark:bg-white/5 dark:text-white transition-all"
                                placeholder="yourname@candy.com" required />
                        </div>
                    </div>

                    <div class="flex flex-col gap-2">
                        <label class="text-[#181113] dark:text-gray-200 text-sm font-bold px-4">Password</label>
                        <div class="relative">
                            <span
                    ...
                    <div class="flex flex-col gap-2">
                        <label class="text-[#181113] dark:text-gray-200 text-sm font-bold px-4">Confirm Password</label>
                        <div class="relative">
                            <span
                                class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-primary/60">verified_user</span>
